...
- API-backed smoke scripts (`smoke:auth`, `smoke:catalog`, `smoke:cms`) default to `localhost:2511`; run them only against local/QA data because catalog/CMS smokes create synthetic records and clean them up.
