        ...
        <Card>
          <CardContent sx={{ p: theme => `${theme.spacing(10.5, 8, 8)} !important` }}>
            <Box sx={{ mb: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src='/images/Tcc_logo.png' height={30} alt='logo image' />
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              <FormControl sx={{ display: 'flex', mb: 4 }} size="small">
                <InputLabel htmlFor='auth-reset-password-new-password'>Old Password</InputLabel>
                <OutlinedInput
                  autoFocus
                  label='Old Password'
                  ...
                  endAdornment={
                    <InputAdornment position='end'>
                      ...
                      >
                        <Icon icon={values.showOldPassword ? 'tabler:eye' : 'tabler:eye-off'} />
                      </IconButton>
                    </InputAdornment>
                  }
                />
