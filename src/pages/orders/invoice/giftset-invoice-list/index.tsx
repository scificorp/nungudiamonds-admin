...
import { CURRENCY_VALUE, DATEPICKER_DATE_FORMAT, SYSTEM_LOGO } from "src/AppConfig"
...
import { GIFTSET_INVOICE_DETAIL } from "src/services/AdminServices"
...
const GiftsetInvoiceDetails = () => {
    ...
    // console.log(`${IMG_ENDPOINT}${SYSTEM_LOGO_MAIN}`);
...
return false;
    ...
    useEffect(() => {
        const orderId: string = id as string
                    ...
                    <Card>
                        <CardContent>
                            <Button
                                ...
                                color='secondary'
                                variant='outlined'
                                href={`/orders/invoice/giftset-invoice-layout/?id=${orderID}`}
                            >
                                Print
                            </Button>
...
export default GiftsetInvoiceDetails
